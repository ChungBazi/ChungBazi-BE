...
public class UserController {
    ...
    @Operation(summary = "사용자 정보 등록 API", description = "사용자 정보(지역, 취업상태, 소득, 추가사항, 관심사, 학력)를 등록합니다.")
    ...
    @PatchMapping("/update")
    @Operation(summary = "사용자 정보 수정 API", description = "사용자 정보(지역, 취업상태, 소득, 추가사항, 관심사, 학력)를 수정합니다.")
