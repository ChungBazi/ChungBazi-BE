...
public class ChatBotController {
    ...
    @GetMapping("/{policyId}")
    @Operation(summary = "정책 상세 조회 API", description = "정책 상세 조회 API")
    public ApiResponse<ChatBotResponseDTO.PolicyDetailDto> getPolicyDetails(@PathVariable Long policyId){
        return ApiResponse.onSuccess((chatBotService.getPolicyDetails(policyId)));
    }
