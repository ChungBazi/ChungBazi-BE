...
public class KakaoAuthController {
    ...
    public ApiResponse<TokenResponseDTO.LoginTokenResponseDTO> registerUser(@RequestBody TokenRequestDTO request) {
    ...
    public ApiResponse<TokenResponseDTO.RefreshTokenResponseDTO> refreshAccessToken(@AuthUser Long userId) {
        TokenDTO token = kakaoAuthService.recreateAccessToken(userId);
        return ApiResponse.onSuccess(kakaoAuthService.createRefreshTokenResponse(token));
    }
    ...
    public ApiResponse<String> logout(@AuthUser Long userId) {
        ...
        kakaoAuthService.logoutUser(userId, token);
    ...
    public ApiResponse<String> deleteAccount(@AuthUser Long userId) {
        String token = (String) SecurityContextHolder.getContext().getAuthentication().getCredentials();
        kakaoAuthService.deleteUserAccount(userId, token);
